...
public class CmrStorageWriter extends StorageWriter {
	...
	/**
	 * Filename for business context.
	 */
	private static final String BUSINESS_FILENAME = "business";
	...
	protected void writeBusinessContextData() throws IOException {
		...
		super.writeNonDefaultDataObject(businessTransactions, BUSINESS_FILENAME + StorageFileType.BUSINESS_CONTEXT_FILE.getExtension());
	}
